...
export default function CongestionDistribution() {
  ...
  const fetchCongestionDistribution = async () => {
    // Demo mode: Generate mock congestion distribution
    setLoading(true)
    ...
    const lowCount = hourlyData.low
    const moderateCount = hourlyData.moderate
    const heavyCount = hourlyData.heavy
    const severeCount = hourlyData.severe
